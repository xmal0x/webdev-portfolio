export const aboutBio = (
    <div className="text-gray-text p-4">
        ...
        <p>I've been involved in development for over 7 years now.
            I started with .NET on the backend but transitioned to full-stack development,
            and it seems that's where I truly appreciated the beauty of frontend work.
            For a long time, I worked with Angular, but recently,
            I've been captivated by React, and I can't seem to get enough of it at the moment.</p>
        <br/>
        <p>In my work, I highly value teamwork because, in my opinion,
            ...
            So feel free to reach out with any questions.</p>
        <br/>
        ...
        <br/>
        <p>If you have any projects, ideas, or simply interesting propositions,
...
export const aboutEducation = (
    <div className="text-gray-text p-4">
        <p>I hold an engineering degree and graduated from the Faculty of Radio Engineering and Electronics,
            ...
            increasingly drawn to software development.</p>
        <br/>
        <p>My educational background in engineering has provided me with a strong foundation in problem-solving and
            ...
            of
            technology and programming languages.</p>
        <br/>
        <p>
